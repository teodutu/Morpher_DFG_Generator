...
rm *_munittrace.log
rm memtraces/*
clang -D CGRA_COMPILER  -target i386-unknown-linux-gnu -c -emit-llvm -O2 -fno-vectorize -fno-slp-vectorize -fno-tree-vectorize -fno-inline -fno-unroll-loops microspeech_int16_test.c -S -o microspeech.ll
